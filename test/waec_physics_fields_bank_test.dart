...
import 'package:exam_prep/features/exam/quiz/question_bank/waec_physics_fields_bank.dart';

void main() {
  test('WAEC Physics (Waves & Fields) bank is well-formed', () {
    final questions = buildWaecPhysicsFieldsQuestions();
    // ignore: avoid_print
    print('Total WAEC Physics (Waves & Fields) questions: ${questions.length}');
