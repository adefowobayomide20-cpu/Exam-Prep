...
void main() {
  test('JAMB Fine Art bank is well-formed', () {
    final questions = buildJambFineArtQuestions();
    // ignore: avoid_print
    print('Total JAMB Fine Art questions: ${questions.length}');
