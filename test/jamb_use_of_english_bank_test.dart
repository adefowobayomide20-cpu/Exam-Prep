...
void main() {
  test('JAMB Use of English bank is well-formed', () {
    final questions = buildJambUseOfEnglishQuestions();
    // ignore: avoid_print
    print('Total JAMB Use of English questions: ${questions.length}');
    ...
    for (final q in questions) {
      ...
      expect(q.subject, 'Use of English');
    }
  });
}
