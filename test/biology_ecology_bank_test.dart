...
import 'package:exam_prep/features/exam/quiz/question_bank/biology_ecology_bank.dart';

void main() {
  test('Biology Ecology bank is well-formed', () {
    final questions = buildBiologyEcologyQuestions();
    // ignore: avoid_print
    print('Total Ecology questions: ${questions.length}');
