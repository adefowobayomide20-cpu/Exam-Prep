...
import 'package:exam_prep/features/exam/quiz/question_bank/waec_agric_land_bank.dart';

void main() {
  test('WAEC Agricultural Science Land bank is well-formed', () {
    final questions = buildWaecAgricLandQuestions();
    // ignore: avoid_print
    print('Total WAEC Agric Land questions: ${questions.length}');
