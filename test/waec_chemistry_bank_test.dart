...
void main() {
  test('WAEC Chemistry bank (merged Intro + Advanced) is well-formed', () {
    final questions = buildWaecChemistryQuestions();
    // ignore: avoid_print
    print('Total WAEC Chemistry questions: ${questions.length}');
