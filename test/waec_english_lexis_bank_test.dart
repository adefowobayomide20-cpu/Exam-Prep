...
import 'package:exam_prep/features/exam/quiz/question_bank/waec_english_lexis_bank.dart';

void main() {
  test('WAEC English Lexis bank is well-formed', () {
    final questions = buildWaecEnglishLexisQuestions();
    // ignore: avoid_print
    print('Total Lexis questions: ${questions.length}');
