...
import 'package:exam_prep/features/exam/quiz/question_bank/waec_physics_mechanics_bank.dart';

void main() {
  test('WAEC Physics Mechanics bank is well-formed', () {
    final questions = buildWaecPhysicsMechanicsQuestions();
    // ignore: avoid_print
    print('Total WAEC Physics Mechanics questions: ${questions.length}');
