...
void main() {
  test('JAMB Economics bank is well-formed', () {
    final questions = buildJambEconomicsQuestions();
    // ignore: avoid_print
    print('Total JAMB Economics questions: ${questions.length}');
