...
void main() {
  test('JAMB Commerce bank is well-formed', () {
    final questions = buildJambCommerceQuestions();
    // ignore: avoid_print
    print('Total JAMB Commerce questions: ${questions.length}');
