...
import 'package:exam_prep/features/exam/quiz/question_bank/waec_chemistry_intro_bank.dart';

void main() {
  test('WAEC Chemistry Intro bank is well-formed', () {
    final questions = buildWaecChemistryIntroQuestions();
    // ignore: avoid_print
    print('Total WAEC Chemistry Intro questions: ${questions.length}');
