...
void main() {
  test('JAMB Principles of Accounts bank is well-formed', () {
    final questions = buildJambAccountsQuestions();
    // ignore: avoid_print
    print('Total JAMB Principles of Accounts questions: ${questions.length}');
    ...
    for (final q in questions) {
      ...
      expect(q.subject, 'Principles of Accounts');
    }
  });
}
