...
void main() {
  test('JAMB Physical and Health Education bank is well-formed', () {
    final questions = buildJambPheQuestions();
    // ignore: avoid_print
    print('Total JAMB PHE questions: ${questions.length}');
    ...
    for (final q in questions) {
      ...
      expect(q.subject, 'Physical and Health Education');
    }
  });
}
