...
import 'package:exam_prep/features/exam/quiz/question_bank/waec_chemistry_advanced_bank.dart';

void main() {
  test('WAEC Chemistry Advanced bank is well-formed', () {
    final questions = buildWaecChemistryAdvancedQuestions();
    // ignore: avoid_print
    print('Total WAEC Chemistry Advanced questions: ${questions.length}');
