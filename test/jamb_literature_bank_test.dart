...
void main() {
  test('JAMB Literature-in-English bank is well-formed', () {
    final questions = buildJambLiteratureQuestions();
    // ignore: avoid_print
    print('Total JAMB Literature-in-English questions: ${questions.length}');
    ...
    for (final q in questions) {
      ...
      expect(q.subject, 'Literature in English');
    }
  });
}
