...
import 'package:exam_prep/features/exam/quiz/question_bank/unn_post_utme_bank.dart';

void main() {
  test('UNN Post-UTME bank is well-formed', () {
    final questions = buildUnnPostUtmeQuestions();
    // ignore: avoid_print
    print('Total UNN Post-UTME questions: ${questions.length}');
