...
import 'package:exam_prep/features/exam/quiz/question_bank/biology_living_things_bank.dart';

void main() {
  test('Biology Living Things bank is well-formed', () {
    final questions = buildBiologyLivingThingsQuestions();
    // ignore: avoid_print
    print('Total Living Things questions: ${questions.length}');
