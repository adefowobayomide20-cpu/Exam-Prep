...
void main() {
  test('JAMB Christian Religious Studies bank is well-formed', () {
    final questions = buildJambCrsQuestions();
    // ignore: avoid_print
    print('Total JAMB Christian Religious Studies questions: ${questions.length}');
    ...
    for (final q in questions) {
      ...
      expect(q.subject, 'Christian Religious Studies');
    }
  });
}
