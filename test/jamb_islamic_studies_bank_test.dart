...
void main() {
  test('JAMB Islamic Studies bank is well-formed', () {
    final questions = buildJambIslamicStudiesQuestions();
    // ignore: avoid_print
    print('Total JAMB Islamic Studies questions: ${questions.length}');
    ...
    for (final q in questions) {
      ...
      expect(q.subject, 'Islamic Studies');
    }
  });
}
