...
void main() {
  test('JAMB History bank is well-formed', () {
    final questions = buildJambHistoryQuestions();
    // ignore: avoid_print
    print('Total JAMB History questions: ${questions.length}');
