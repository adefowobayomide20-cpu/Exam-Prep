...
void main() {
  test('JAMB Computer Studies bank is well-formed', () {
    final questions = buildJambComputerStudiesQuestions();
    // ignore: avoid_print
    print('Total JAMB Computer Studies questions: ${questions.length}');
    ...
    for (final q in questions) {
      ...
      expect(q.subject, 'Computer Studies');
    }
  });
}
