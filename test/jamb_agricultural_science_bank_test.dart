...
void main() {
  test('JAMB Agricultural Science bank is well-formed', () {
    final questions = buildJambAgriculturalScienceQuestions();
    // ignore: avoid_print
    print('Total JAMB Agricultural Science questions: ${questions.length}');
