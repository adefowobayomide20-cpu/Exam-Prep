...
import 'package:exam_prep/features/exam/quiz/question_bank/biology_continuity_bank.dart';

void main() {
  test('Biology Continuity of Life bank is well-formed', () {
    final questions = buildBiologyContinuityQuestions();
    // ignore: avoid_print
    print('Total Continuity of Life questions: ${questions.length}');
