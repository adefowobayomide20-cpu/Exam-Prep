...
import 'package:exam_prep/features/exam/quiz/question_bank/oau_post_utme_bank.dart';

void main() {
  test('OAU Post-UTME bank is well-formed', () {
    final questions = buildOauPostUtmeQuestions();
    // ignore: avoid_print
    print('Total OAU Post-UTME questions: ${questions.length}');
