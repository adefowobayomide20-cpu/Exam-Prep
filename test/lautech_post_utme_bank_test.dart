...
import 'package:exam_prep/features/exam/quiz/question_bank/lautech_post_utme_bank.dart';

void main() {
  test('LAUTECH Post-UTME bank is well-formed', () {
    final questions = buildLautechPostUtmeQuestions();
    // ignore: avoid_print
    print('Total LAUTECH Post-UTME questions: ${questions.length}');
