...
import 'package:exam_prep/features/exam/quiz/question_bank/waec_english_structure_bank.dart';

void main() {
  test('WAEC English Structure bank is well-formed', () {
    final questions = buildWaecEnglishStructureQuestions();
    // ignore: avoid_print
    print('Total Structure questions: ${questions.length}');
