...
void main() {
  test('WAEC Physics bank (merged Mechanics + Fields) is well-formed', () {
    final questions = buildWaecPhysicsQuestions();
    // ignore: avoid_print
    print('Total WAEC Physics questions: ${questions.length}');
