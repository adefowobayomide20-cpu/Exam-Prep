...
import 'package:exam_prep/features/exam/quiz/question_bank/futa_post_utme_bank.dart';

void main() {
  test('FUTA Post-UTME bank is well-formed', () {
    final questions = buildFutaPostUtmeQuestions();
    // ignore: avoid_print
    print('Total FUTA Post-UTME questions: ${questions.length}');
